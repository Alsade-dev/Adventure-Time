...
class EventList:
    ...
    Instance Attributes:
        - first: Event object representing the first event in the game, None if no event has occured yet
        - last: Event object representing the last event in the game, None if no event has occured yet
    ...
    def get_id_log(self) -> list[int]:
        ...
        while curr is not None:
            ids_visited.append(curr.id_num)
            curr = curr.next
        return ids_visited
